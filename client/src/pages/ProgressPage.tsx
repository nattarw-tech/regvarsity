      ...
      <section className="border-b border-border">
        <div className="max-w-5xl mx-auto px-6 py-14">
          ...
          <p className="text-lg max-w-2xl text-muted-foreground mb-8">
            Everything is stored in your browser. No account, no tracking, clear
            your browser data and it resets.
          </p>
                ...
                <div className="grid grid-cols-[1fr_auto] items-center gap-4 py-5">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground tabular-nums">
                      ...
                      {mp.quickChecksDone > 0 && (
                        <>
                          {" "}
                          · {mp.quickChecksDone} Quick Check
                          {mp.quickChecksDone !== 1 ? "s" : ""} done
                        </>
                      )}
                      {test ? (
                        test.passed ? (
                          ...
                          <>
                            {" "}
                            · test best {test.bestScorePercent}% (not yet
                            passed)
                          </>
                        )
                      ) : mod.moduleTest ? (
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This clears every chapter tick, Quick Check result, test
                    score and badge from this browser. It cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
