    ...
    <>
      ...
      {!open && (
        <button
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.28 0.08 255), oklch(0.52 0.14 195))",
            color: "white",
          }}
        >
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    >
                      <p className="font-semibold mb-1">
                        Hello! I'm RegVarsity AI.
                      </p>
                      <p style={{ color: "var(--muted-foreground)" }}>
                        Ask me anything about UK and EU financial regulation.
                        FCA rules, AML/KYC, MiFID II, Crypto, MiCA, UK GDPR, or
                        any term in the glossary. I'll explain it in plain
                        English.
                      </p>
                    </div>
                    {/* Suggested questions */}
