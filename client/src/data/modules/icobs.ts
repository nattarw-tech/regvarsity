...
export const moduleICOBS: Module = {
  ...
  whoItAppliesTo:
    "All firms that sell, administer, or advise on general insurance products.",
  chapters: [
    {
      id: "icobs-1",
      number: 1,
      ...
      quizQuestions: [
        {
          id: "icobs-1-q1",
          question:
            "What is the Insurance Product Information Document (IPID)?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "The IPID is a standardised two-page summary covering what is insured, what is not, restrictions on cover and how to complain. It must be in plain, clear language, so important exclusions cannot be buried in small print.",
        },
        {
          id: "icobs-1-q2",
          question:
            "Why did the FCA introduce special rules for add-on insurance products?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "FCA research found that customers buying add-ons, such as travel insurance sold with a holiday, often did not understand what they were buying. The rules now require firms to give customers time to consider add-on products separately.",
        },
        {
          id: "icobs-1-q3",
          question:
            "What did the 'price walking' ban of 1 January 2022 require?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "The FCA found insurers were quietly increasing prices for loyal renewal customers while offering cheaper deals to new customers. From 1 January 2022, renewal customers must be offered the same price as equivalent new customers.",
        },
      ],
    },
    {
      ...
      quizQuestions: [
        {
          id: "icobs-2-q1",
          question:
            "What duty replaced 'utmost good faith' for consumers under the 2012 Act?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "The Consumer Insurance (Disclosure and Representations) Act 2012 replaced utmost good faith with a duty to take reasonable care not to misrepresent when answering the insurer's questions. Consumers no longer have to volunteer information they were never asked about.",
        },
        {
          id: "icobs-2-q2",
          question:
            "A customer carelessly understates their mileage. The insurer would have charged 25% more premium if told the truth. What remedy applies to a claim?",
          options: [
          ...
          correctIndex: 2,
          explanation:
            "For careless misrepresentation, the remedy is proportionate: if the insurer would have charged a higher premium, it can reduce the claim payout proportionately. Voiding the policy and keeping the premium is reserved for deliberate or reckless misrepresentation.",
        },
        {
          id: "icobs-2-q3",
          ...
          correctIndex: 1,
          explanation:
            "The Insurance Act 2015 brought similar reforms to commercial (business) insurance, replacing the old disclosure duty with a duty of fair presentation of the risk, with proportionate remedies for breaches.",
        },
      ],
    },
  ],
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation:
          "ICOBS applies to general insurance products sold in the UK, including motor, home, travel and payment protection insurance, covering the whole journey from sale to claims handling.",
      },
      {
        id: "icobs-test-q2",
        question:
          "What must an insurance intermediary (broker) disclose under ICOBS?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Brokers must tell customers whether they are acting on behalf of the customer or the insurer, how they are paid, and any material conflicts of interest, alongside providing the IPID for the product.",
      },
      {
        id: "icobs-test-q3",
        ...
        correctIndex: 1,
        explanation:
          "Any insurance product sold must be consistent with the customer's demands and needs. Non-advised sales require enough questions to understand basic needs; advised sales require a personal recommendation with reasons.",
      },
      {
        id: "icobs-test-q4",
        ...
        correctIndex: 0,
        explanation:
          "ICOBS 8 requires prompt and fair claims handling: no unreasonable rejections, prompt settlement once liability is agreed, and keeping customers informed throughout.",
      },
      {
        id: "icobs-test-q5",
        question:
          "Before 2012, what could an insurer do if a consumer innocently failed to volunteer a material fact?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Under the old doctrine of utmost good faith, failing to volunteer material information, even innocently, let the insurer void the policy and refuse all claims. The 2012 Act replaced this harsh all-or-nothing rule with proportionate remedies.",
      },
      {
        id: "icobs-test-q6",
        question:
          "When a consumer's misrepresentation is deliberate or reckless, what remedy does the insurer have?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Deliberate or reckless misrepresentation lets the insurer void the policy and keep the premium. Careless misrepresentation attracts only a proportionate remedy, such as a reduced payout reflecting the premium that should have been charged.",
      },
    ],
  },
};
