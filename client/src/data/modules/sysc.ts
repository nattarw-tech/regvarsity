...
export const moduleSYSC: Module = {
  ...
  whoItAppliesTo:
    "All FCA-authorised firms. Enhanced requirements apply to banks, building societies, and large investment firms.",
  chapters: [
    {
      id: "sysc-1",
      number: 1,
      ...
      quizQuestions: [
        {
          id: "sysc-1-q1",
          question:
            "What was the 'responsibility gap' that SMCR was designed to close?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Under the old Approved Persons Regime, executives could say 'I didn't know' or 'that was someone else's area' because the regime did not require firms to map out who was responsible for what. The Parliamentary Commission on Banking Standards called the APR 'not fit for purpose', and SMCR was the response.",
        },
        {
          id: "sysc-1-q2",
          question:
            "A breach occurs in an area a Senior Manager is responsible for. Under the Duty of Responsibility, what must the Senior Manager show to avoid personal liability?",
          options: [
        ...
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "SMCR came into force for banks in 2016 and was extended to all FCA-regulated firms in December 2019. It replaced the Approved Persons Regime.",
        },
      ],
    },
    {
...
**SMF17 - Money Laundering Reporting Officer (MLRO)**: The individual responsible for the firm's AML/KYC compliance and for making Suspicious Activity Reports (SARs) to the National Crime Agency.`,
        },
        {
          id: "sysc-2-2",
          heading:
            "2.2 - Statements of Responsibilities and the Responsibilities Map",
      ...
      quizQuestions: [
        {
          id: "sysc-2-q1",
          question:
            "Which SMF holder is responsible for the firm's AML compliance and for making Suspicious Activity Reports to the National Crime Agency?",
          options: [
          ...
          correctIndex: 3,
          explanation:
            "SMF17, the Money Laundering Reporting Officer (MLRO), is responsible for the firm's AML/KYC compliance and for making Suspicious Activity Reports (SARs) to the National Crime Agency. SMF16 covers wider compliance oversight, but AML reporting sits with the MLRO.",
        },
        {
          id: "sysc-2-q2",
          question:
            "What makes a Statement of Responsibilities acceptable to the FCA?",
          options: [
        ...
        },
        {
          id: "sysc-2-q3",
          question:
            "How does the Certification Regime differ from the Senior Managers Regime?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Certified Persons, employees who could cause significant harm, do not need FCA approval. Instead their firm must certify them as fit and proper, and renew that certification every year. Senior Managers, by contrast, need FCA pre-approval for their function.",
        },
      ],
    },
    {
      ...
      quizQuestions: [
        {
          ...
          correctIndex: 2,
          explanation:
            "The Individual Conduct Rules apply to almost everyone working in an FCA-regulated firm. The exception is ancillary staff, such as cleaners, caterers and IT contractors who do not perform regulated activities.",
        },
        {
          id: "sysc-3-q2",
          question:
            "A Senior Manager delegates oversight of a business area to a deputy, who then makes serious errors. What does Senior Manager Conduct Rule 8 say about this?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Rule 8 says that if you delegate a responsibility you remain accountable for it. You must delegate to a competent, appropriate person and effectively oversee how they discharge the responsibility. Delegation is allowed, but it is never a way to offload accountability.",
        },
        {
          id: "sysc-3-q3",
          question:
            "Which Individual Conduct Rule is the personal equivalent of Principle 6 (customers' interests)?",
          options: [
          ...
          correctIndex: 2,
          explanation:
            "Rule 4 requires individuals to pay due regard to the interests of customers and treat them fairly, mirroring Principle 6 which applies at firm level. Similarly, Rule 1 mirrors Principle 1 on integrity.",
        },
      ],
    },
  ],
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation:
          "SMCR replaced the Approved Persons Regime (APR). The Parliamentary Commission on Banking Standards found the APR 'not fit for purpose' because it let senior managers escape accountability when things went wrong. SMCR closes that gap by mapping responsibility to named individuals.",
      },
      {
        id: "sysc-test-q2",
        ...
        correctIndex: 1,
        explanation:
          "SMCR has three components: the Senior Managers Regime for the most senior individuals, the Certification Regime for employees who could cause significant harm, and the Conduct Rules setting minimum standards of behaviour for nearly all staff.",
      },
      {
        id: "sysc-test-q3",
        question:
          "Which firms must produce a Responsibilities Map showing how all responsibilities are allocated across Senior Managers?",
        options: [
        ...
        correctIndex: 2,
        explanation:
          "Enhanced firms, the largest and most complex such as major banks and large investment firms, must produce a Responsibilities Map covering every area of the firm's regulated activities with no gaps. Core and Limited Scope firms face lighter requirements.",
      },
      {
        id: "sysc-test-q4",
        question:
          "How often must a firm renew the certification of its Certified Persons?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Firms must certify that Certified Persons are fit and proper to perform their role, and this certification must be renewed annually. If someone is found not fit and proper, the firm must withdraw certification and cannot let them continue in the role.",
      },
      {
        id: "sysc-test-q5",
        question:
          "Which of these is a Senior Manager Conduct Rule rather than an Individual Conduct Rule?",
        options: [
          "Act with integrity",
        ...
        correctIndex: 2,
        explanation:
          "The four Senior Manager Conduct Rules (Rules 6 to 9) cover effective control, compliance, delegation and disclosure in the manager's area of responsibility. Integrity, market conduct and customer fairness are Individual Conduct Rules that apply to nearly all staff.",
      },
      {
        id: "sysc-test-q6",
        question:
          "The MLRO at a firm fails to make Suspicious Activity Reports to the National Crime Agency. Which Senior Manager Function does the MLRO hold?",
        options: ["SMF1", "SMF4", "SMF16", "SMF17"],
        correctIndex: 3,
        explanation:
          "The Money Laundering Reporting Officer holds SMF17 and is responsible for AML/KYC compliance and for making SARs to the National Crime Agency. SMF16 is Compliance Oversight, SMF4 is the Chief Risk Officer, and SMF1 is the CEO.",
      },
      {
        id: "sysc-test-q7",
        question:
          "Under Senior Manager Conduct Rule 9, what personal obligation does a Senior Manager have towards regulators?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Rule 9 places a personal duty on each Senior Manager to disclose appropriately any information the FCA or PRA would reasonably expect notice of. It is not enough that the firm as a whole reports; the obligation attaches to the individual.",
      },
      {
        id: "sysc-test-q8",
