...
export const moduleAML: Module = {
  ...
  whoItAppliesTo:
    "Banks, investment firms, crypto businesses, estate agents, accountants, solicitors, and many other sectors.",
  chapters: [
    {
      id: "aml-1",
      number: 1,
      ...
      quizQuestions: [
        {
          id: "aml-1-q1",
          question:
            "A criminal transfers drug money between accounts in several countries and through shell companies to disguise where it came from. Which stage of money laundering is this?",
          options: ["Placement", "Layering", "Integration", "Structuring"],
          correctIndex: 1,
          explanation:
            "Layering is the second stage, where multiple transactions are used to put distance between the money and its criminal source, for example transfers across borders and through shell companies. Placement is when the money first enters the system, and integration is when it re-enters the legitimate economy.",
        },
        {
          id: "aml-1-q2",
          question:
            "Under POCA 2002, can you commit a money laundering offence without actually knowing the money was criminal?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "POCA does not require proof that you knew the property was criminal. If you had reasonable grounds to suspect it was, that may be enough. This is why wilful blindness offers no protection in AML.",
        },
        {
          id: "aml-1-q3",
          question:
            "Which stage of money laundering is riskiest for the criminal, and why?",
          options: [
          ...
          correctIndex: 2,
          explanation:
            "Placement is the riskiest stage for the criminal because the funds are still closest to their illegal origin, for example large cash deposits from drug sales. Once the money is inside the financial system, layering and integration make it progressively harder to trace.",
        },
      ],
    },
    {
      ...
      quizQuestions: [
        {
          id: "aml-2-q1",
          question:
            "A customer with no existing relationship asks a firm to process a one-off transaction of €16,000. What must the firm do?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Under the Money Laundering Regulations 2017, CDD is required for occasional transactions above €15,000, including linked transactions that together exceed the threshold. Nothing here automatically requires a SAR; a report is only needed if there is suspicion.",
        },
        {
          id: "aml-2-q2",
          question:
            "At what ownership level must a firm identify a company's beneficial owners under the MLRs?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "The MLRs set the beneficial ownership threshold at more than 25% of shares or voting rights, or otherwise exercising control over management. Criminals deliberately structure holdings below 25%, so firms must also consider who actually exercises control regardless of formal percentages.",
        },
        {
          id: "aml-2-q3",
          question:
            "Which of these situations makes Enhanced Due Diligence mandatory?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "EDD is mandatory for PEPs and their associates, customers from high-risk third countries, complex or unusually large transactions, and non-face-to-face relationships. Routine account activity does not trigger EDD.",
        },
      ],
    },
    {
      ...
      quizQuestions: [
        {
          id: "aml-3-q1",
          question:
            "How should a firm treat a UK Member of Parliament opening an account, compared with a foreign government minister?",
          options: [
          ...
          correctIndex: 2,
          explanation:
            "Both are PEPs and both require Enhanced Due Diligence, including senior management approval and source of wealth checks. But FCA guidance, clarified in the 2023 MLR amendments, says domestic PEPs should be treated as lower risk than foreign PEPs unless specific risk factors are present.",
        },
        {
          id: "aml-3-q2",
          question:
            "What is the maximum civil penalty OFSI can impose for a sanctions breach?",
          options: [
            "£100,000 flat",
          ...
          correctIndex: 1,
          explanation:
            "OFSI can impose civil monetary penalties of up to £1 million or 50% of the value of the breach, whichever is higher. Criminal prosecution for sanctions breaches can also result in up to 7 years' imprisonment.",
        },
        {
          id: "aml-3-q3",
          question:
            "A bank submits a SAR about a customer. The customer then asks their relationship manager why their payment is delayed. What must the relationship manager NOT do?",
          options: [
          ...
          correctIndex: 1,
          explanation:
            "Telling the customer that a SAR has been made, or that they are under investigation, is the criminal offence of tipping off. The firm must continue dealing with the customer normally while the NCA considers the report.",
        },
      ],
    },
  ],
    ...
    questions: [
      {
        id: "aml-test-q1",
        question:
          "Put the three stages of money laundering in the correct order.",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "Money is first placed into the financial system (placement), then moved through transactions designed to disguise its source (layering), and finally re-enters the legitimate economy appearing lawful (integration).",
      },
      {
        id: "aml-test-q2",
        question:
          "Which Act makes it a criminal offence to conceal, convert or transfer criminal property in the UK?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "The Proceeds of Crime Act 2002 (POCA) contains the principal money laundering offences: concealing or transferring criminal property, arranging or facilitating its use, and acquiring, using or possessing it.",
      },
      {
        id: "aml-test-q3",
        ...
        correctIndex: 1,
        explanation:
          "SDD can only be applied where the firm has assessed the risk as genuinely low. It is a risk-based reduction in measures, not a shortcut, and it never applies automatically.",
      },
      {
        id: "aml-test-q4",
        question:
          "Standard CDD on a corporate customer requires which of the following?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "For companies, standard CDD includes identifying the customer, verifying identity from reliable independent sources, understanding the purpose of the relationship, and identifying beneficial owners, meaning those who own or control more than 25% of shares or voting rights.",
      },
      {
        id: "aml-test-q5",
        ...
        correctIndex: 1,
        explanation:
          "For PEPs, firms must obtain senior management approval before establishing the relationship, establish the source of wealth and source of funds, and apply enhanced ongoing monitoring throughout the relationship.",
      },
      {
        id: "aml-test-q6",
        ...
        correctIndex: 1,
        explanation:
          "OFSI, part of HM Treasury, administers UK financial sanctions and maintains the consolidated list that firms must screen customers and transactions against. Since Brexit the UK runs its own independent sanctions regime.",
      },
      {
        id: "aml-test-q7",
        question:
          "A firm wants to proceed with a transaction it suspects involves criminal property. What is the correct procedure?",
        options: [
        ...
        correctIndex: 1,
        explanation:
          "The firm should submit a consent SAR (also called a defence against money laundering request) to the NCA. The NCA has 7 days to refuse consent, extendable to 31 days with notice of investigation. If no response arrives within the relevant period, the firm can proceed.",
      },
      {
        id: "aml-test-q8",
        ...
        correctIndex: 2,
        explanation:
          "The UK receives around 900,000 SARs a year, one of the highest rates in the world. The NCA uses them to identify laundering networks, recover criminal assets and support investigations.",
      },
    ],
  },
};
